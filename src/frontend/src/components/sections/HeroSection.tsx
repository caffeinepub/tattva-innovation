      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            <span className="text-brand-gold">&amp; AI Systems</span>
            <br />
          ...
          >
            From voter data management to AI-powered automation, Tattva
            Innovation builds secure, scalable systems that give organizations a
